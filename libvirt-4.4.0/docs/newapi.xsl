...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="check" mode="acl">
        <tr>
            <td>
                <a href="../acl.html#object_{@object}">
                    <xsl:value-of select="@object"/>
                </a>
            </td>
            <td>
                <a href="../acl.html#perm_{@object}_{@perm}">
        ...
        <table class="navigation" width="100%" summary="Navigation header"
            ...
            <tr valign="middle">
                <xsl:if test="$previous">
                    <td>
                        <a accesskey="p" href="libvirt-{$previous/@name}.html">
                            <img src="left.png" width="24" height="24" border="0" alt="Prev"></img>
                        </a>
                    </td>
                    <th align="left">
                        <a href="libvirt-{$previous/@name}.html">
                ...
                <td>
                    <a accesskey="u" href="index.html">
                        <img src="up.png" width="24" height="24" border="0" alt="Up"></img>
                    </a>
                </td>
                <th align="left">
                ...
                <td>
                    <a accesskey="h" href="../index.html">
                        <img src="home.png" width="24" height="24" border="0" alt="Home"></img>
                    </a>
                </td>
                <th align="center">
                    <a href="../index.html">The virtualization API</a>
                </th>
                <xsl:if test="$next">
                    <th align="right">
                        <a href="libvirt-{$next/@name}.html">
                            <xsl:value-of select="$next/@name"/>
                        </a>
                    </th>
                    <td>
                        <a accesskey="n" href="libvirt-{$next/@name}.html">
                            <img src="right.png" width="24" height="24" border="0" alt="Next"></img>
                        </a>
                    </td>
                </xsl:if>
            </tr>
    ...
    <xsl:template mode="dumptoken" match='*'>
        ...
        <xsl:choose>
            <xsl:when test="$ref">
                ...
                <a href="libvirt-{$ref/@file}.html#{$ref/@name}">
    ...
    <xsl:template name="formatblock">
        ...
        <xsl:choose>
            ...
            <xsl:when test="starts-with($block, '  ')">
                <pre class="code">
                    <xsl:for-each select="str:tokenize($block, '&#xA;')">
                        <xsl:choose>
    ...
    <xsl:template match="file">
        ...
        <xsl:variable name="title">Module
            <xsl:value-of select="$name"/>
            from
    ...
    <xsl:template name="mainpage">
        <xsl:variable name="title">Reference Manual for
            <xsl:value-of select="/api/@name"/>
        </xsl:variable>
        <xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;
        </xsl:text>
