            ...
            <xsl:for-each select="/html:html/html:body/html:h2[count(html:a) = 1]">
                ...
                <li>
                    ...
                    <xsl:if test="count(./following-sibling::html:h3[preceding-sibling::html:h2[1] = $thish2 and count(html:a) = 1]) > 0">
                        <ul>
                            <xsl:for-each
                                    select="./following-sibling::html:h3[preceding-sibling::html:h2[1] = $thish2 and count(html:a) = 1]">
                                ...
                                <li>
                                    ...
                                    <xsl:if test="count(./following-sibling::html:h4[preceding-sibling::html:h3[1] = $thish3 and count(html:a) = 1]) > 0">
                                        <ul>
                                            <xsl:for-each
                                                    select="./following-sibling::html:h4[preceding-sibling::html:h3[1] = $thish3 and count(html:a) = 1]">
                                                ...
                                                <li>
                                                    ...
                                                    <xsl:if test="count(./following-sibling::html:h5[preceding-sibling::html:h4[1] = $thish4 and count(html:a) = 1]) > 0">
                                                        <ul>
                                                            <xsl:for-each
                                                                    select="./following-sibling::html:h5[preceding-sibling::html:h4[1] = $thish4 and count(html:a) = 1]">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <xsl:if test="count(./following-sibling::html:h6[preceding-sibling::html:h5[1] = $thish5 and count(html:a) = 1]) > 0">
                                                                        <ul>
                                                                            <xsl:for-each
                                                                                    select="./following-sibling::html:h6[preceding-sibling::html:h5[1] = $thish5 and count(html:a) = 1]">
                                                                                <li>
                                                                                    <a href="#{html:a/@id}">
                                                                                        <xsl:value-of
                                                                                                select="html:a/text()"/>
            ...
            <body>
                ...
                <div id="nav">
                    ...
                    <div id="jumplinks">
                        <ul>
                            <li>
                                <a href="{$href_base}downloads.html">Download</a>
                            </li>
                            <li>
                                <a href="{$href_base}contribute.html">Contribute</a>
                            </li>
                            <li>
                                <a href="{$href_base}docs.html">Docs</a>
                            </li>
                        </ul>
                    </div>
                    <div id="search">
                ...
                <div id="footer">
                    <div id="contact">
                        ...
                        <ul>
                            <li>
                                <a href="{$href_base}contact.html#email">email</a>
                            </li>
                            <li>
                                <a href="{$href_base}contact.html#irc">irc</a>
                            </li>
                        </ul>
                    </div>
                    <div id="community">
                    ...
                    <div id="conduct">
                        Participants in the libvirt project agree to abide by
                        <a href="{$href_base}governance.html#codeofconduct">the project code of conduct</a>
                    </div>
                    <br class="clear"/>
                </div>
            </body>
